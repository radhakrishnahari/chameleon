 ...
 ***
 *
 * @brief Chameleon zgered parallel algorithm
 *
 * @version 1.3.0
                        ...
                        RUNTIME_request_t  *request )
{
    ...
    chameleon_desc_init( &Wcol, "GERED_Wcol", CHAMELEON_MAT_ALLOC_GLOBAL, ChamRealDouble,
                         2, 1, A->mt * 2, A->nt, A->mt * 2, A->nt, P, Q,
                         NULL, NULL, A->get_rankof_init, A->get_rankof_init_arg );

    /* Matrix to compute the global frobenius norm */
    chameleon_desc_init( &Welt, "GERED_Welt", CHAMELEON_MAT_ALLOC_GLOBAL, ChamRealDouble,
                         2, 1, workmt*2, worknt, workmt*2, worknt, P, Q,
                         NULL, NULL, NULL, NULL );
