                        ...
                        RUNTIME_request_t  *request )
{
    ...
    chameleon_desc_init( &Wcol, "HERED_Wcol", CHAMELEON_MAT_ALLOC_GLOBAL, ChamRealDouble,
                         2, 1, A->mt * 2, A->nt, A->mt * 2, A->nt, P, Q,
                         NULL, NULL, A->get_rankof_init, A->get_rankof_init_arg );

    /* Matrix to compute the global frobenius norm */
    chameleon_desc_init( &Welt, "HERED_Welt", CHAMELEON_MAT_ALLOC_GLOBAL, ChamRealDouble,
