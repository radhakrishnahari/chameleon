...
Feel free to use the following publications to reference Chameleon:
  ...
  * Regarding distributed memory:
    - Agullo, Emmanuel and Aumage, Olivier and Faverge, Mathieu and
      ...
      with a Sequential Task-based Programming Model*, /IEEE Transactions on Parallel and Distributed Systems/,
      [[https://inria.hal.science/hal-01618526][First Online: 16 June 2016]].
