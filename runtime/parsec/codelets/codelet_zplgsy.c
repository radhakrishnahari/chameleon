                        ...
                        int bigM, int m0, int n0, unsigned long long int seed )
{
    ...
    parsec_dtd_insert_task(
        PARSEC_dtd_taskpool, CORE_zplgsy_parsec, options->priority, PARSEC_DEV_CPU, "zplgsy",
        sizeof(CHAMELEON_Complex64_t), &bump,                          PARSEC_VALUE,
        ...
        sizeof(int),               &bigM,                          PARSEC_VALUE,
        sizeof(int),               &m0,                            PARSEC_VALUE,
        sizeof(int),               &n0,                            PARSEC_VALUE,
        sizeof(unsigned long long int),               &seed,       PARSEC_VALUE,
        PARSEC_DTD_ARG_END );
}
