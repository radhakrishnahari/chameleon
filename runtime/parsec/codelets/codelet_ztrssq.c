                        ...
                        const CHAM_desc_t *SCALESUMSQ, int SCALESUMSQm, int SCALESUMSQn )
{
    ...
    parsec_dtd_insert_task(
        PARSEC_dtd_taskpool, CORE_ztrssq_parsec, options->priority, PARSEC_DEV_CPU, "trssq",
        ...
        PASSED_BY_REF,          RTBLKADDR( SCALESUMSQ, double, SCALESUMSQm, SCALESUMSQn ),    PARSEC_INOUT | PARSEC_AFFINITY,
        PARSEC_DTD_ARG_END );
}
