...
static inline int
cl_zplghe_is_bubble( struct starpu_task *t, void *_args )
{
...
static void
cl_zplghe_bubble_func( struct starpu_task *t, void *_args )
{
    struct cl_zplghe_args_s *clargs  = (struct cl_zplghe_args_s *)(t->cl_arg);
    ...
    chameleon_pzplghe( clargs->bump, ChamUpperLower, clargs->tileA->mat,
                         ...
                         int bigM, int m0, int n0, unsigned long long int seed )
{
    ...
    if ( is_bubble ) {
        b_args = malloc( sizeof(bubble_args_t) + sizeof(struct cl_zplghe_args_s) );
    ...
    rt_starpu_insert_task(
        ...
        STARPU_BUBBLE_GEN_DAG_FUNC,     cl_zplghe_bubble_func,
